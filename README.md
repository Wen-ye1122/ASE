...
* RNA-seq alignment, quantification, SNP calling, genotype imputation, and quality control (This pipeline is available [here](https://github.com/FarmGTEx/PigGTEx-Pipeline-v0/tree/53064b6528079b3fbb71b58cbb4415b82de69fd4/02_RNA-Seq) );
* Allele-specific expression (ASE) analysis (This pipeline is available [here](https://github.com/FarmGTEx/PigGTEx-Pipeline-v0/tree/53064b6528079b3fbb71b58cbb4415b82de69fd4/11_ASE_analysis) )
